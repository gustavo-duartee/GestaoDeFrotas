                                ...
                                <div className="flex h-full flex-col overflow-y-scroll bg-white py-6 shadow-xl rounded-md">
                                    ...
                                    <div className="px-4 sm:px-6 py-2 flex gap-2">
                                        <div className="flex-grow ">
                                            <button onClick={onRequestClose} className="w-full text-black bg-white hover:bg-gray-50 border border-gray-300 focus:ring-1 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 focus:outline-none">Excluir</button>
                                        </div>
                                        <div className="flex-grow">
                                            <button onClick={onRequestClose} className="w-full text-white bg-gray-900 hover:bg-gray-700 focus:ring-1 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 focus:outline-none">Editar</button>
                                        </div>
                                    </div>
